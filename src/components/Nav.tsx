        ...
        <nav className="nav">
            <ul className='nav__list'>
                <li className='nav__item'>
                    <a href="#intro" className={`nav__link ${active === "intro" ? "active" : ""}`} onClick={(e) => handleClick(e, 0, "intro")}>Intro</a>
                    <Squares />
                </li>
                <li className='nav__item'>
                    <a href="#formation" className={`nav__link ${active === "formation" ? "active" : ""}`} onClick={(e) => handleClick(e, 1, "formation")}>Formation</a>
                    <Squares />
                </li>
                <li className='nav__item'>
                    <a href="#services" className={`nav__link ${active === "services" ? "active" : ""}`} onClick={(e) => handleClick(e, 2, "services")}>Services</a>
                    <Squares />
                </li>
                <li className='nav__item'>
                    <a href="#technologies" className={`nav__link ${active === "technologies" ? "active" : ""}`} onClick={(e) => handleClick(e, 3, "technologies")}>Technologies</a>
                    <Squares />
                </li>
                <li className='nav__item'>
                    <a href="#realisations" className={`nav__link ${active === "realisations" ? "active" : ""}`} onClick={(e) => handleClick(e, 4, "realisations")}>Réalisations</a>
                    <Squares />
                </li>
                <li className='nav__item'>
                    <a href="#contact" className={`nav__link ${active === "contact" ? "active" : ""}`} onClick={(e) => handleClick(e, 5, "contact")}>Contact</a>
                    <Squares />
                </li>
            </ul>
            <div className="nav__social">
                <a href="https://www.linkedin.com/in/nicolas-morvant/" className="nav__linkedin" target='_blank'>
                    <i className="fa-brands fa-linkedin" title="Linkedin"></i>
                </a>
                <a href="https://discordapp.com/users/nicolasmorvant" className="nav__discord" target='_blank'>
                    <i className="fa-brands fa-discord" title="Discord"></i>
                </a>
                <a href="https://github.com/nicolasmorvant" className="nav__github" target='_blank'>
